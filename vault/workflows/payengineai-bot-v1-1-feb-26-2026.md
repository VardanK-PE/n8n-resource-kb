...
status: active
last_modified: 2026-06-01T22:00:27.497Z
tags: []
fingerprint: "ae5e2105224e10186fc971f05da8dc9585054fbf8400b1f50d383f5e598b8cdb"
...
- **Nodes:** 210
- **Last modified:** 2026-06-01T22:00:27.497Z
...
- [[../resources/credentials/1jtiaqogn0rcfpc1|Anthropic account]] (`anthropicApi`, id `1jtIAQOGn0RcFpc1`) — node "Anthropic Chat Model1" (id `259a75f8-3afc-4f1f-9b4c-5439bb202ab0`)
- [[../resources/credentials/1jtiaqogn0rcfpc1|Anthropic account]] (`anthropicApi`, id `1jtIAQOGn0RcFpc1`) — node "Anthropic Chat Model5" (id `2632de6e-fb3f-444d-b514-23337335e0ee`)
...
- [[../resources/credentials/b9eqlthyefjazsbz|Google Sheets account (Main One Used)]] (`googleApi`, id `B9eqlthYefJAzSbz`) — node "Execution Logger" (id `663c9db8-97fa-4147-9b24-76a65602a27e`)
...
- [[../resources/credentials/1jtiaqogn0rcfpc1|Anthropic account]] (`anthropicApi`, id `1jtIAQOGn0RcFpc1`) — node "Anthropic (Spartak@gmail.com)" (id `7a763d1f-ce85-44b4-8aa3-108cab5d0b85`)
- [[../resources/credentials/godp5gdyjaspv2fj|Anthropic (spartak@platformfactory.io)]] (`anthropicApi`, id `Godp5GdYJAspV2fj`) — node "Anthropic (spartak@platformfactory.io)" (id `7a872924-2d67-44bb-bd5c-08e5a90daf7a`)
...
- [[../resources/credentials/1jtiaqogn0rcfpc1|Anthropic account]] (`anthropicApi`, id `1jtIAQOGn0RcFpc1`) — node "Anthropic Chat Model2" (id `cf536bf1-bb38-4216-bcaa-d99c5e44676a`)
- [[../resources/credentials/1jtiaqogn0rcfpc1|Anthropic account]] (`anthropicApi`, id `1jtIAQOGn0RcFpc1`) — node "Anthropic Chat Model" (id `cfd54e90-c8fc-4661-b70d-28e33abb4a5e`)
...
- [[../resources/credentials/1jtiaqogn0rcfpc1|Anthropic account]] (`anthropicApi`, id `1jtIAQOGn0RcFpc1`) — node "Anthropic Chat Model4" (id `e1c1436f-3e20-4fe9-b2fc-604fc451f0d3`)
...
- [[../resources/google-sheets/1iibhzez9yrtypccwdolvqkpk5fa392dubqsbehauxbw|PayEngineAI Bot - Email Logs]] (id `1IIBhzeZ9YRtYPccwDOlvqkpk5Fa392dUBqSbeHAuXbw`) — op `append`, tab `AIExecutionHistory` — node "Execution Logger" (id `663c9db8-97fa-4147-9b24-76a65602a27e`)
...
- [[payengineai-bot-v1-1-feb-26-2026|PayEngineAI Bot (v1.1) - Feb 26 2026]] (n8n_id `0yjTSaTSRLaCOgvH`) — node "Read Emails1" (id `086d0da1-9831-4cd4-9d3c-f5164afe01b0`)
...
- [[payengineai-bot-v1-1-feb-26-2026|PayEngineAI Bot (v1.1) - Feb 26 2026]] (n8n_id `0yjTSaTSRLaCOgvH`) — node "Call PayEngineBot" (id `56bc2196-99c3-4223-9ca3-9ab970fac434`)
- [[payengineai-bot-v1-1-feb-26-2026|PayEngineAI Bot (v1.1) - Feb 26 2026]] (n8n_id `0yjTSaTSRLaCOgvH`) — node "Create Draft In Merchants Inbox1" (id `ad52b28d-1dcd-4a9b-b35f-aa24fe185c1b`)
...
- [[payengineai-bot-v1-1-feb-26-2026|PayEngineAI Bot (v1.1) - Feb 26 2026]] (n8n_id `0yjTSaTSRLaCOgvH`) — node "Call Onboarding Correspondence Aging Report Tool" (id `e64d7759-24d4-429f-b13a-b2434c194f30`)
- [[payengineai-bot-v1-1-feb-26-2026|PayEngineAI Bot (v1.1) - Feb 26 2026]] (n8n_id `0yjTSaTSRLaCOgvH`) — node "Execute Workflow1" (id `f1a4b9c6-4f86-435f-b0e3-bf602f97e8aa`)

## Used by (workflows)

- [[payengineai-bot-v1-1-feb-26-2026|PayEngineAI Bot (v1.1) - Feb 26 2026]] — node "Call Onboarding Correspondence Aging Report Tool" (id `e64d7759-24d4-429f-b13a-b2434c194f30`)
- [[payengineai-bot-v1-1-feb-26-2026|PayEngineAI Bot (v1.1) - Feb 26 2026]] — node "Call PayEngineBot" (id `56bc2196-99c3-4223-9ca3-9ab970fac434`)
- [[payengineai-bot-v1-1-feb-26-2026|PayEngineAI Bot (v1.1) - Feb 26 2026]] — node "Create Draft In Merchants Inbox1" (id `ad52b28d-1dcd-4a9b-b35f-aa24fe185c1b`)
- [[payengineai-bot-v1-1-feb-26-2026|PayEngineAI Bot (v1.1) - Feb 26 2026]] — node "Execute Workflow1" (id `f1a4b9c6-4f86-435f-b0e3-bf602f97e8aa`)
- [[payengineai-bot-v1-1-feb-26-2026|PayEngineAI Bot (v1.1) - Feb 26 2026]] — node "Read Emails1" (id `086d0da1-9831-4cd4-9d3c-f5164afe01b0`)
