...
- **Nodes:** 49
- **Last modified:** 2026-06-04T21:16:48.830Z
...
- [[../resources/credentials/b9eqlthyefjazsbz|Google Sheets account (Main One Used)]] (`googleApi`, id `B9eqlthYefJAzSbz`) — node "Download file" (id `3c6b9c36-ba89-4047-93c7-e036c28dea51`)
...
- [[../resources/http-urls/api-next-servicetitan-io|api-next.servicetitan.io]] — `GET https://api-next.servicetitan.io/settings/v2/tenant/349984906/technicians` — node "Get Technicians2" (id `c333a6ee-51e7-4e20-9513-a584049ca0ab`)
...
- [[../resources/http-urls/auth-next-servicetitan-io|auth-next.servicetitan.io]] — `POST https://auth-next.servicetitan.io/connect/token` — node "Obtain Access Token (NEXT env)" (id `e4592cd7-8b87-460c-8d29-2c42b630624f`)
...
- [[../resources/http-urls/api-next-servicetitan-io|api-next.servicetitan.io]] — `GET https://api-next.servicetitan.io/jpm/v2/tenant/349984906/jobs` — node "Get Jobs1" (id `fbbe9e88-474d-4a97-8ff3-bacbb8ff5380`)
