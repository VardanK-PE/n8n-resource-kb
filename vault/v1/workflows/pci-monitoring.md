...
- [[../resources/credentials/nuywkwefalsyaavg|Support slack]] (`slackApi`, id `NuyWkwefAlSyAaVg`) — node "Send a message2" (id `ac4eacd9-e880-4e50-a8d4-2d2df4c561c4`)
...
- *(dynamic spreadsheet)* — op `appendOrUpdate`, tab `={{ $('loop through each partner').last().json.partner_reports_gsheet_sheeet_id }}` — node "Append or update row in sheet1" (id `1b55509b-a8b8-4386-9310-26f24d36a087`)
- *(dynamic spreadsheet)* — op `clear`, tab `={{ $('loop through each partner').last().json.partner_reports_gsheet_sheeet_id }}` — node "Clear sheet" (id `498cc049-6d07-4922-8c36-5ed51b77cf40`)
