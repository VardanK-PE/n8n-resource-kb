...
current_name: "PE ACH TRANSACTION REPORTS"
...
- **Current name:** PE ACH TRANSACTION REPORTS
- **Historical aliases:**
...
- [[../../workflows/residuals-generator-v7-active-latest-2026-07-15|Residuals Generator V7 (ACTIVE) (latest 2026-07-15)]] — op `?`, tab `={{ $('Get Master Spreadsheet ID').item.json.name.substring(0, 4) }}-{{ $('Get Master Spreadsheet ID').item.json.name.substring(4, 6) }}-ALL-AGGREGATE` — node "All ACH Transactions Report" (id `eed9c8da-3b50-4d06-a3ee-5e4b915eac3e`)
- [[../../workflows/residuals-generator-v7-active-latest-2026-07-15|Residuals Generator V7 (ACTIVE) (latest 2026-07-15)]] — op `?`, tab `={{ $json.name.substring(0, 4) }}-{{ $json.name.substring(4, 6) }}-ALL-AGGREGATE` — node "Get row(s) in sheet2" (id `e2b447b9-8ace-4232-b0d5-f90172823bf2`)
