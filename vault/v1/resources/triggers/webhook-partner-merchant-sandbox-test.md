...
# webhook — partner-merchant-sandbox-test

- **Resource id (canonical):** `webhook:partner-merchant-sandbox-test`
- **Current name:** webhook — partner-merchant-sandbox-test
- **Trigger type:** `webhook`
- **Path:** `partner-merchant-sandbox-test` (`POST`)
