...
type: trigger
instance: v1
resource_id: "schedule:every 4 hour(s)"
current_name: "schedule — every 4 hour(s)"
aliases: ["schedule — every 4 hour(s)"]
auto_generated_at: 2026-08-19T19:29:04Z
---

<!-- auto:start -->

# schedule — every 4 hour(s)

- **Resource id (canonical):** `schedule:every 4 hour(s)`
- **Current name:** schedule — every 4 hour(s)
...
- [[../../workflows/payengineai-bot-v1-1-feb-26-2026-saot95eapiyc8s56|PayEngineAI Bot (v1.1) - Feb 26 2026]] — node "Schedule Trigger3" (id `4832ddd0-7b11-4a9b-b91f-4d4c2f943353`)
- [[../../workflows/payengineai-bot-v1-1-feb-26-2026|PayEngineAI Bot (v1.2) - Jun 12 2026]] — node "Schedule Trigger3" (id `00bfd1c5-8fc2-4c00-a2b7-7bfa0f2be497`)
