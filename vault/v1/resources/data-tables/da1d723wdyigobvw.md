...
# Dispute - Merchant Responses

- **Resource id (canonical):** `DA1d723WDyIGoBVW`
- **Current name:** Dispute - Merchant Responses
- **Path:** `/projects/z00SrPPWOSGROMFl/datatables/DA1d723WDyIGoBVW`
- **Table ID:** `DA1d723WDyIGoBVW`

## Used by

- [[../../workflows/dispute-case-handler|Dispute - Case Handler]] — node "Get row(s)" (id `51adc6eb-df8e-4eac-a0be-a6d11423a762`)
- [[../../workflows/dispute-case-handler|Dispute - Case Handler]] — node "Update row(s)3" (id `1c3b8d7a-454d-4e48-a5bd-493dcea7be78`)
