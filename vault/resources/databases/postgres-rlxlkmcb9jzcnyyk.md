...
# postgres (via Postgres ST production read replica)

- **Resource id (canonical):** `postgres/rlXLkMcb9jzcnYYK`
- **Current name:** postgres (via Postgres ST production read replica)
- **Engine:** `postgres`
- **Credential:** Postgres ST production read replica
...
- [[../../workflows/st-prod-logs-monitor|ST Prod Logs Monitor]] — op `executeQuery` — node "Postgres" (id `b8a0bd88-7b84-4f3b-a794-f83786bea116`)
