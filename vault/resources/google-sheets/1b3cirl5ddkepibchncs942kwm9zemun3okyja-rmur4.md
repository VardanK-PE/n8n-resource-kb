...
# 1B3cIrL5ddKePiBCHNCs942KwM9zEmUn3okYja_rmUR4

- **Resource id (canonical):** `1B3cIrL5ddKePiBCHNCs942KwM9zEmUn3okYja_rmUR4`
- **Current name:** 1B3cIrL5ddKePiBCHNCs942KwM9zEmUn3okYja_rmUR4
- **Spreadsheet ID:** `1B3cIrL5ddKePiBCHNCs942KwM9zEmUn3okYja_rmUR4`
...
- [[../../workflows/managed-by-spartak-ai-agent-partner-merchant-bulk-import-sync-sandbox|[Managed by Spartak AI Agent] Partner Merchant Bulk Import Sync (SANDBOX)]] — op `append`, tab `Sync Log` — node "Debug: After Gateway" (id `debug-after-gateway`)
- [[../../workflows/managed-by-spartak-ai-agent-partner-merchant-bulk-import-sync-sandbox|[Managed by Spartak AI Agent] Partner Merchant Bulk Import Sync (SANDBOX)]] — op `append`, tab `Sync Log` — node "Debug: After Prepare" (id `debug-after-prepare`)
- [[../../workflows/managed-by-spartak-ai-agent-partner-merchant-bulk-import-sync-sandbox|[Managed by Spartak AI Agent] Partner Merchant Bulk Import Sync (SANDBOX)]] — op `append`, tab `Sync Log` — node "Debug: After Switch" (id `debug-after-switch`)
